          ...
          <div>
            ...
            <div className='flex flex-col justify-between'>
              ...
              <div className='mt-5 p-5 flex flex-col items-center m-auto w-1/2 rounded-2xl bg-white'>
                ...
                <div className='mt-5 w-full items-center  flex flex-row'>
                  ...
                  <div className='w-1/2 flex flex-col'>
                    ...
                    <div className='w-full p-10 flex flex-col'>
                      <p>Nombre*</p>
                      <input onChange={(event) => {setName(event.target.value)}} className='w-full my-2 text-black py-2 px-4 rounded-full bg-white border border-zinc-600' placeholder='Nombre:' value={name}  type="text" id="name" name="name"/><br/><br/>
                      <p>Apellido paterno*</p>
                      <input onChange={(event) => {setFirstLastName(event.target.value)}} className='w-full my-2 text-black py-2 px-4 rounded-full bg-white border border-zinc-600' placeholder='Apellido Paterno' value={first_last_name} type="text" id="first_last_name" name="first_last_name"/><br/><br/>
                      <p>Apellido Materno*</p>
                      <input onChange={(event) => {setSecondLastName(event.target.value)}} className='w-full my-2 text-black py-2 px-4 rounded-full bg-white border border-zinc-600' placeholder='Apellido Materno' value={second_last_name} type="text" id="second_last_name" name="second_last_name"/><br/><br/>
                    </div>
                ...
                <div className='w-1/4'>
                  <input onClick={()=>{}} className='mt-5 text-white w-full py-2 px-4 rounded-full bg-zinc-400 mx-auto hover:bg-cyan-400 hover:cursor-pointer' type="submit" value="Actualizar"/><br/><br/>
                </div>
              </div>
            </div>
          </div>
