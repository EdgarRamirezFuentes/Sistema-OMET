                        ...
                        <div className='w-full flex flex-col items-center'>
                            ...
                            <div className='w-full flex flex-col justify-between'>
                              ...
                              <div className='mb-10 w-full flex flex-row justify-center'>
                                <input onChange={(event) => {}} className='w-1/2 text-black py-2 px-4 rounded-full bg-white border border-zinc-600' placeholder='RFC' value={""} type="text" id="rfc" name="rfc"/><br/><br/>
                              </div>
