                            ...
                            <div className='mt-5 w-full items-center flex flex-row'>
                                ...
                                <div className='w-full flex flex-col items-center'>
                                    ...
                                    <div className='w-full flex flex-col justify-between'>
                                        ...
                                        <div className='mb-10 w-full flex flex-row justify-center'>
                                            <input value={caption} disabled onChange={(event) => {setName(event.target.value)}} className='w-1/2 text-black py-2 px-4 rounded-full bg-white border border-zinc-600' placeholder='Nombre' type="text" id="project_name" name="project_name"/><br/><br/>
                                        </div>
