...
function Input({ label, labelDescription, needed, leftLabel, type, name, id, placeholder, error, disabledInput, register, ...rest }) {
    return (
        <div>
            {label && (
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                    ...
                    name={name}
                    id={id}
                    className={`${error ? 'border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500' : 'border-gray-300 text-gray-800 placeholder:text-gray-300 focus:ring-v2-blue-text-login focus:border-v2-blue-text-login'} transition-all ${disabledInput && 'opacity-80 bg-gray-200 cursor-not-allowed'} block w-full ${leftLabel ? 'pl-7' : 'pl-4'} sm:text-sm rounded-md`}
