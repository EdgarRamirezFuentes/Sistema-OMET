...
def create_list_views(main_directory, project_app):
    ...
    for app_model in app_models:
        ...
        create_view_path = f'web/src/{project_app_name}/{app_model.name}/{app_model.name}CreateView.jsx'
        update_view_path = f'web/src/{project_app_name}/{app_model.name}/{app_model.name}UpdateView.jsx'
        retrieve_view_path = f'web/src/{project_app_name}/{app_model.name}/{app_model.name}RetrieveView.jsx'
