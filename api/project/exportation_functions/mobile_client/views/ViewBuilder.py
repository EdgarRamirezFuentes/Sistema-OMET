...
class ViewBuilder:
    ...
    def __init__(self, app_model):
        ...
        self.__list_view_script = get_template_file_content(SCRIPT_TEMPLATE_URLS['mobile_client_list_view'])
        self.__create_view_script = get_template_file_content(SCRIPT_TEMPLATE_URLS['mobile_client_create_view'])
        self.__update_view_script = get_template_file_content(SCRIPT_TEMPLATE_URLS['mobile_client_update_view'])
        self.__retrieve_view_script = get_template_file_content(SCRIPT_TEMPLATE_URLS['mobile_client_retrieve_view'])
    ...
    def __build_foreign_key_use_effects(self):
        ...
        for foreign_key_relation in relation:
            foreign_key_function = get_template_file_content(SCRIPT_TEMPLATE_URLS['mobile_client_foreign_key_use_effect'])
            related_model_field = foreign_key_relation.model_field_related
            related_model_name = related_model_field.app_model.name
            related_model_field_name = related_model_field.name
            foreign_key_function = foreign_key_function.replace('{{FOREIGN_KEY_MODEL_NAME}}', related_model_name)
    ...
    def __build_foreign_key_flags(self):
        ...
        for foreign_key_relation in relation:
            foreign_key_flag = get_template_file_content(SCRIPT_TEMPLATE_URLS['mobile_client_use_state_hook'])
            related_model_field = foreign_key_relation.model_field_related
            related_model_name = related_model_field.app_model.name
            related_model_field_name = related_model_field.name
    ...
    def __build_foreign_key_selected_item_hooks(self):
        ...
        for many_to_many_field in many_to_many_fields:
            foreign_key_selected_item_hook = get_template_file_content(SCRIPT_TEMPLATE_URLS['mobile_client_use_state_hook'])
